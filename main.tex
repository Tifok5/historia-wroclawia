...
\vspace{-60px}
\includegraphics[width=0.48\textwidth]{images/wroclaw.png}
\vspace{-10px}
\caption{Wrocław w XII–XIII wieku}
\vspace{10px}
\includegraphics[width=0.48\textwidth]{images/kosciol.jpg}
\vspace{-10px}
...
\begin{wrapfigure}{r}{0.5\textwidth}
\includegraphics[width=0.48\textwidth]{images/XVII_wroclaw.jpg}
\vspace{-10px}
\caption{XVII-wieczny Wrocław}
\vspace{10px}
\includegraphics[width=0.48\textwidth]{images/widok_miasta.jpg}
\vspace{-10px}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.5]{images/mapa.jpg}
\caption{Mapa Wrocławia i okolic w 1900; nazwy okolicznych wsi, obecnie osiedli miasta, w językach niemieckim i polskim źródło: \url{http://www.breslau-wroclaw.de} }
\end{figure}
...
Villa Colonia. Miejsce podpisania kapitulacji Wrocławia\footnote{Elżbieta Osowicz: Villa Colonia: Tutaj poddał się Breslau. 2013-12-19. s. Radio Wrocław. [dostęp 2017-11-15].}
...
\section{Zobacz też}
\begin{itemize}
  \item \href{https://pl.wikipedia.org/wiki/Stare_Miasto_we_Wrocławiu}{Stare Miasto we Wrocławiu}
  \item \href{https://pl.wikipedia.org/wiki/Ludność_Wrocławia}{ludność Wrocławia}
\end{itemize}
